...
type Service interface {
	...
	FinalTenantPayment(ctx context.Context, collaboratorID, authorizedBy string, req FinalSettlementRequest) (*FinalSettlementResult, error)
	FinalCollaboratorPayment(ctx context.Context, collaboratorID, authorizedBy string, req FinalSettlementRequest) (*FinalSettlementResult, error)
	AcceptReceipt(ctx context.Context, ledgerEntryID, acceptedBy, expectedParty string, req AcceptReceiptRequest) (*PrintableReceiptDTO, error)
