ALTER TABLE expenses ADD COLUMN price_list_item_code TEXT NULL;
ALTER TABLE expenses ADD COLUMN gold_price_date DATE NULL;
ALTER TABLE expenses ADD COLUMN calculation_method TEXT NULL;

CREATE INDEX IF NOT EXISTS idx_expenses_price_list_item_code ON expenses(price_list_item_code);
CREATE INDEX IF NOT EXISTS idx_expenses_gold_price_date ON expenses(gold_price_date);
CREATE INDEX IF NOT EXISTS idx_expenses_calculation_method ON expenses(calculation_method);
